...
class SbpController extends Controller
{
    ...
    public function destroyPermanen($id)
    {
        ...
        return redirect()->route('sbp-list')->with('success','Surat Bukti Penindakan Berhasil Terhapus Permanen');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('sbp-list')->with('success','Surat Bukti Penindakan Berhasil dikembalikan');
    }
}
