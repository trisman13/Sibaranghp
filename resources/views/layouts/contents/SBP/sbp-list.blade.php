                        ...
                        <td>
                          <div style="max-width: 80px">
                            <a
                              ...
                              href="{{route('sbp.edit',$surat->id) }}">Sunting </a> 

                            <a 
                              role="button"
                              onclick="return confirm ('Apa yakin ingin menghapus data {{$surat->nomor_surat}} ini?')"
                              class="btn btn-block btn-danger btn-sm d-inline-block"
                              href="{{ route('sbp.destroy', $surat->id) }}">Hapus</a>
                        </div>
                        </td>
                      </tr>
                      @endforeach
